...
<!-- For DSP unmoderated sites: -->

<!-- Title of Page -->
 <?
  $this->title = Yii::t('app', "DSP Unmoderated sites(".count($sites_list).") of $ssp_name (ID: $ssp_id)");
 ...
 <!-- Date From - To -->
<?php echo Html::beginForm('index.php?r=traffic/dsp_unmoderated', 'GET'); ?>
...
<?php foreach ($sites_list as $site_id => $data) : ?>
    ...
    <tr class="clickableTR">
        ...
        <td><?= $site_id; ?></td>
        <td><?= number_format($data['err_moderation_site'], 0, ',', ' '); ?></td>
    </tr>
<?php endforeach; ?>
<?else:?>
 No sites found...
